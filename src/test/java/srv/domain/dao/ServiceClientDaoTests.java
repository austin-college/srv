...
class ServiceClientDaoTests {
	...
	void testListAll() throws Exception {
		...
		assertEquals("903-444-4440", sc3.getMainContact().getPrimaryPhone());
		assertEquals("401-322-1201", sc3.getMainContact().getSecondaryPhone());
		...
		assertEquals("803-426-1527", sc3.getOtherContact().getPrimaryPhone());
		assertEquals("800-191-9412", sc3.getOtherContact().getSecondaryPhone());
