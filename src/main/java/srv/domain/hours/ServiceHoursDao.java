...
public interface ServiceHoursDao {
	...
	public ServiceHours create(Integer scid, Integer uid, Integer eid, Double hours, String stat, String reflection, String description, String contactName, String contactContact) throws Exception;

	public void delete(int shid) throws Exception;
	
	public void update(Integer shid, Integer scid, Integer uid, Integer eid, Double hours, String stat, String reflection, String description, String contactName, String contactContact) throws Exception;
